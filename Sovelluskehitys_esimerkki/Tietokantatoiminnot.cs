...
namespace Sovelluskehitys_esimerkki
{
    class Tietokantatoiminnot
    {
        ...
        public void paivitaDataGrid(string kysely, string taulu, DataGrid grid)     // julkiseksi, jotta voi käyttää muualla (MainWindow.cs)
        {
        ...
        public void paivitaComboBox(ComboBox kombo1, ComboBox kombo2)              // julkiseksi, jotta voi käyttää muualla (MainWindow.cs)
        {
            SqlConnection kanta = new SqlConnection(polku);
            kanta.Open();
